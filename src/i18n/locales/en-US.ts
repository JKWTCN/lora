export default {
  ...
  main: {
    ...
    dialog: {
      ...
      folder: 'Folder',
      url: 'URL',
      runAsAdmin: 'Always open as administrator',
  ...
  newProject: {
    ...
    launchArgsPlaceholder: 'Please enter launch arguments (e.g.: --fullscreen --debug)',
    projectHotkey: 'Project Hotkey',
    projectHotkeyPlaceholder: 'Press a combination with at least one modifier',
    runAsAdmin: 'Always open as administrator',
    ...
    userCancelled: 'User Cancelled',
    browseFileError: 'Failed to browse file',
    selectIconError: 'Failed to select icon',
    fillRequiredFields: 'Please fill in the required information',
    createProjectError: 'Failed to create project',
    creating: 'Creating...',
    created: 'Created',
    customProject: 'Custom',
    builtInItems: 'Built-in Items',
    startMenuItems: 'Start Menu',
    selectStartMenuShortcut: 'Select Start Menu Item',
    selectStartMenuShortcutError: 'Failed to select Start Menu item',
    noStartMenuItems: 'No Start Menu items found',
    searchStartMenuPlaceholder: 'Search Start Menu items or paths...',
    ...
    presets: {
      ...
      restart: 'Restart',
      sleep: 'Sleep',
      startMenuPrograms: 'Start Menu Programs',
      commonStartMenuPrograms: 'Common Start Menu',
      startupFolder: 'Startup Folder',
      appsFolder: 'Apps List'
    },
    form: {
      projectName: 'Project Name',
      category: 'Category',
